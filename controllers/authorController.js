...
exports.author_create_post = function (req, res, next) {
  ...
  req.checkBody('date_of_birth', 'Invalid birth date use format dd/mm/yyyy').optional({
    checkFalsy: true
  }).isDate();
  req.checkBody('date_of_death', 'Invalid death date use format dd/mm/yyyy').optional({
    checkFalsy: true
  }).isDate();
